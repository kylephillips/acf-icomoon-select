=== Advanced Custom Fields: Icomoon Select Field ===
Contributors: kylephillips
Tags: advanced custom fields, icomoon
...
1. Copy the `acf-icomoon_select` folder into your `wp-content/plugins` folder
